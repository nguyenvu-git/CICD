        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-7 py-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-slate-900/70 border rounded-xl text-white placeholder-slate-650 focus:outline-none focus:ring-1 transition-all duration-200
                ${errors.contact_name ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500' : 'border-slate-800 focus:border-pink-500 focus:ring-pink-500'}`}
            />
            {errors.contact_name && (
              <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-slate-900/70 border rounded-xl text-white placeholder-slate-650 focus:outline-none focus:ring-1 transition-all duration-200
                ${errors.phone ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500' : 'border-slate-800 focus:border-pink-500 focus:ring-pink-500'}`}
            />
            {errors.phone && (
              <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-slate-900/70 border rounded-xl text-white placeholder-slate-650 focus:outline-none focus:ring-1 transition-all duration-200
                ${errors.address ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500' : 'border-slate-800 focus:border-pink-500 focus:ring-pink-500'}`}
            />
            {errors.address && (
              <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
