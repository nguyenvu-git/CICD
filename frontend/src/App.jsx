      ...
      <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 selection:bg-purple-500/30 relative">
        ...
        <footer className="border-t border-slate-900 bg-slate-950 py-8 text-center text-xs text-slate-500">
          <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p>© {new Date().getFullYear()} Frontend Stack Boilerplate. All rights reserved.</p>
            <div className="flex gap-4">
              <span className="hover:text-slate-355 transition-colors cursor-default">Vite</span>
              <span>•</span>
              <span className="hover:text-slate-355 transition-colors cursor-default">React.js</span>
              <span>•</span>
              <span className="hover:text-slate-355 transition-colors cursor-default">TailwindCSS v4</span>
            </div>
          </div>
        </footer>
      </div>
