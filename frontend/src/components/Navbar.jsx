...
import { Home, Database, FileText, Cpu, Users, Shield, Receipt, Tag, UserPlus, FolderOpen, Utensils, Truck, Package, FileInput } from 'lucide-react';
          ...
          <div className="flex space-x-1 sm:space-x-2 overflow-x-auto">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  isActive
                    ? 'bg-slate-850 text-emerald-400 border border-slate-700 shadow-[0_0_10px_rgba(16,185,129,0.1)]'
                    : 'text-slate-400 hover:bg-slate-900 hover:text-slate-100 border border-transparent'
                }`
              }
            >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  isActive
                    ? 'bg-slate-850 text-sky-400 border border-slate-700 shadow-[0_0_10px_rgba(14,165,233,0.1)]'
                    : 'text-slate-400 hover:bg-slate-900 hover:text-slate-100 border border-transparent'
                }`
              }
            >
